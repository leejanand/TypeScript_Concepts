...
console.log(student1.getSummary()); //Scott is 15 years old and scored grade A
...
let student2:{
 ...
 console.log(student2.getSummary()); // Marry is 16 years old and scored grade B
...
student3.getSummary = () => {
    return `${student3.name} is ${student3.age} years old and scored grade ${student3.grade}`;
};

console.log(student3.getSummary()); // Scott is 15 years old and scored grade A
